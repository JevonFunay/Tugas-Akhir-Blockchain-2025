...
contract ActivityCertificate {
    ...
    function tokenURI(uint256 tokenId) public view exists(tokenId) returns (string memory) { return _tokenURIs[tokenId]; }
    ...
    function mintCertificate(address to, string memory uri) public onlyMinter returns (uint256) {
        require(to != address(0), "Invalid address");
