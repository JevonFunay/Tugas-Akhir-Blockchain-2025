...
contract ActivityManager {
    ...
    function createActivity(string calldata name, uint256 pointReward) external onlyOwner {
        ...
        nextActivityId += 1;
        activities[activityId] = Activity({ id: activityId, name: name, pointReward: pointReward, isActive: true });
    ...
    function getActivity(uint256 activityId) external view returns (uint256 id, string memory name, uint256 pointReward, bool isActive) {
